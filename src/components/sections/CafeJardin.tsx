            ...
            <ScrollReveal delay={0.2}>
              <div className="p-8 rounded-2xl border-2 border-moss bg-moss/5 relative overflow-hidden">
                ...
                <div className="relative z-10">
                  ...
                  <MagneticButton
                    href="mailto:contacto@sosac.org?subject=Quiero participar en Café y Jardín"
                    className="w-full justify-center px-6 py-4 rounded-full bg-moss text-bg font-semibold text-sm hover:bg-moss-deep transition-colors duration-300"
                  >
